...
const HallsEdit = () => {
  ...
  const getHallsData = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/transport-booking-system/halls/${hallId}`, {
  ...
  const UpdateHallForm = async (e) => {
    ...
    try {
      const response = await axios.put(`${process.env.REACT_APP_SERVER_URL}/transport-booking-system/halls/${hallId}`,
        {
