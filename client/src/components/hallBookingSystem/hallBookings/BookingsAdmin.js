...
const BookingsAdmin = () => {
  ...
  //   try {
  //     await axios.put(`${process.env.REACT_APP_SERVER_URL}/hall-booking-system/bookingsEdit/${selectedBookingId}`,
  //       {
  ...
  const getBookingData = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/hall-booking-system/bookingsAdmin`, {
        withCredentials: true, // include credentials in the request
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"
  ...
  // navigate(`/hall-booking-system/bookingForm/${hallId}/${hallName}`)
  ...
  const updateBooking = async (bookingId, isApproved) => {
    ...
    try {
      const response = await axios.put(`${process.env.REACT_APP_SERVER_URL}/hall-booking-system/bookingsEdit/${bookingId}`,
        {
  ...
  const handleEditClick = (bookingId) => {
    navigate(`/hall-booking-system/bookingsEdit/${bookingId}`)
  };

  const handleViewClick = (bookingId) => {
    navigate(`/hall-booking-system/bookingsView/${bookingId}`)
  };
  return (
    <>
      {/* <Index /> */}
